...
public class Database {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            System.out.println("Maximum ID is " + maxID + ", his owner is" + resultSet1.getString("first_name") + resultSet1.getString("last_name") + resultSet1.getInt("address_id") + resultSet1.getInt("phone_number"));
            ...
            while (resultSet2.next()) {
                System.out.println(resultSet2.getString("first_name") + resultSet2.getString("last_name") + resultSet2.getInt("address_id") + resultSet2.getInt("phone_number") + resultSet2.getInt("id"));
            }
            ...
            for (String surname1 : surnames) {
                ...
                while (resultSet31.next()) {
                    System.out.println(resultSet31.getString("first_name") + resultSet31.getString("last_name") + resultSet31.getInt("address_id") + resultSet31.getInt("phone_number") + resultSet31.getInt("id"));
                }
            }
